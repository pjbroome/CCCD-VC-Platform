...
class VCRequestCreate(BaseModel):
    ...
    email: str = Field(..., max_length=254, description="Patient email address")
    phone: str = Field(..., max_length=40, description="Patient mobile phone number")
    ...
    concern: str = Field(..., min_length=1, max_length=5000, description="Dental concern / consult reason")
