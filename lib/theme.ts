/**
 * Swappable accent themes for the staff (backend) Kleon admin UI.
 * Neutrals stay constant (light Kleon canvas + white cards); only the accent
 * family changes per theme so the backend can be recolored "for fun" anytime.
 * Default = Kleon purple (#7E38D5), matching the Kleon Modern Admin Dashboard.
 */
...
export const THEMES: Theme[] = [
  { id: "purple", name: "Kleon Purple", accent: "#7E38D5", accentStrong: "#6C2BD9", accentSoft: "rgba(126,56,213,0.10)", gradFrom: "#8743DF", gradTo: "#B06BE8", onAccent: "#ffffff", swatch: "linear-gradient(135deg,#8743DF,#B06BE8)" },
...
/** Constant neutral canvas (Kleon light look) — same across all themes. */
