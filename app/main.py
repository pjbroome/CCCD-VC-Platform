...
SUTTON_MODEL = os.environ.get("SUTTON_MODEL", "google/gemini-2.5-flash")  # Primary model via OpenRouter (fast, stable)
...
def _generate_openrouter_reply(system_prompt: str, user_prompt: str, model: str = None, messages: list[dict] = None) -> str:
    ...
    When model is openrouter/auto, the router picks the best model per query."""
